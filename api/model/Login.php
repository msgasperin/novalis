      ...
      private $bloqueo_min   = 15; // minutos de bloqueo
		...
		public function login(string $usuario, string $contrasenia) {	
         ...
         $res = [ 'estatus' => 500, 'message' => 'error', 'data'    => []];
            ...
            $sqlDataEmpresa = $this->dbh->prepare("SELECT nombre, logo, direccion, rfc, telefono, whats_app, correo, web, key_client FROM datos_empresa");
            ...
            $rowEmpresa = $sqlDataEmpresa->fetch(PDO::FETCH_ASSOC);
               ...
               if($row["perfil"] == 'RECEPCION') {
                  ...
                  'emp_whats'      => $rowEmpresa["whats_app"],
